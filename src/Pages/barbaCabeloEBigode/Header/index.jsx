    ...
    <>
      <header className="bg-dark">
        <div className="col-12 d-md-flex justify-content-center align-items-center">
          <div className="d-flex justify-content-center align-items-center col-12 col-md-6 col-lg-6 anima-esquerda-pra-direita">
            <div className="text-center my-5 col-8 col-md-12">
              ...
              <h4 className="display-7 fw-bolder text-white">
                Totalmente Gratuito!
              </h4>
        ...
        >
          <path
            fill="#212529"
            d="M0,100 C360,0 1080,150 1440,100 L1440,0 L0,0 Z"
          >
            <animate
              attributeName="d"
              dur="6s"
              ...
              values="
          M0,100 C360,0 1080,150 1440,100 L1440,0 L0,0 Z;
          M0,90 C360,150 1080,0 1440,90 L1440,0 L0,0 Z;
          M0,100 C360,0 1080,150 1440,100 L1440,0 L0,0 Z
        "
            />
          </path>
