                ...
                <div className="card-body p-5">
                  ...
                  <ul className="list-unstyled mb-4">
                    ...
                    <li className="mb-2">
                      ...
                      <strong>Lembretes via WhatsApp</strong>
                    </li>
                    <li className="mb-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <strong>Agendamento (login opcional)</strong>
                    </li>
                  </ul>
            ...
            <div className="col-lg-6 col-xl-4">
              <div className="card mb-5 mb-xl-0">
                <div className="card-body p-5">
                  ...
                  <div className="mb-3">
                    <span className="display-4 fw-bold">$80</span>
                    <span className="text-muted">/ mês</span>
                  </div>
                  <ul className="list-unstyled mb-4">
                    <li className="mb-2">
            ...
            <div className="col-lg-6 col-xl-4">
              <div className="card">
                <div className="card-body p-5">
                  ...
                  <div className="mb-3">
                    <span className="display-4 fw-bold">$120</span>
                    <span className="text-muted">/ mês</span>
                  </div>
                  <ul className="list-unstyled mb-4">
                    <li className="mb-2">
