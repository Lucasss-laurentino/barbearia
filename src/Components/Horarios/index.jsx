                      ...
                      <div className="col-6">
                        <div className="col-12">
                          <div className="encapsula-icon d-flex justify-content-center align-items-center background-claro col-10">
                            ...
                            <div className="hr">
                              <p className="m-0">09:00 - 10:30</p>
                            </div>
                          </div>
                          <div className="container">
                            <h6 className="my-2">Cliente 1</h6>
                      ...
                      <div className="col-6">
                        <div className="col-12">
                          <div className="encapsula-icon d-flex justify-content-center align-items-center background-claro col-10">
                            ...
                            <div className="hr">
                              <p className="m-0">10:30 - 11:00</p>
                            </div>
                          </div>
                          <div className="container">
                            <h6 className="my-2">Cliente 2</h6>
                    ...
                    <div className="col-12 d-flex">
                      <div className="col-6">
                        <div className="col-12">
                          ...
                          <div className="container">
                            <h6 className="my-2">Cliente 3</h6>
                      ...
                      <div className="col-6">
                        <div className="col-12">
                          <div className="encapsula-icon d-flex justify-content-center align-items-center background-claro col-10">
                            ...
                            <div className="hr">
                              <p className="m-0">11:45 - 13:15</p>
                            </div>
                          </div>
                          <div className="container">
                            <h6 className="my-2">Cliente 4</h6>
                            <p className="m-0">Cabelo/reflexo</p>
                          </div>
                        </div>
                      </div>
